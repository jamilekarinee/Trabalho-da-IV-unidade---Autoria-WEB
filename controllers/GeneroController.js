...
router.get('/', (req, res) => {
  executarConsulta('SELECT * FROM genero', [], res, "Erro na consulta de generos");
});
...
router.put('/', (req, res) => {
  ...
  executarConsulta('UPDATE genero SET nome = ? WHERE id = ?', [nome, id], res, "Erro ao atualizar genero");
});
